...
import com.leyu.Gateway.Content;
import com.leyu.Gateway.Topic;
import com.leyu.Gateway.TopicData;
import com.leyu.Gateway.TopicListener;
...
public class PageTopic extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        gateway.getTopic(new TopicListener(){
			...
			public void onComplete(TopicData data) {
				...
				ImageRequest request = ImageRequestBuilder.newBuilderWithSource(Uri.parse(data.mPicture))
						.setResizeOptions(new ResizeOptions(width, height))
						.setLocalThumbnailPreviewsEnabled(true).setProgressiveRenderingEnabled(true)
						.build();
				SimpleDraweeView image = ((SimpleDraweeView) mRootView.findViewById(R.id.topic_picture));
	...
	class LeyuAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			if (m_Data.get(position).mType.isEmpty()) {
				...
				for (TextView title : holder.mTitles) {
					title.setText(m_Data.get(position).mText);
				}
				//
				...
				convertView.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						...
						bundle.putString(PageDetail.ARG, new Gson().toJson(new DetailArgs(m_Data.get(position).mText, uri.toString())));
				...
				holder.mTitle.setText(m_Data.get(position).mText);
